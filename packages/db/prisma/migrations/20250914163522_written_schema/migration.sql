...
-- CreateIndex
CREATE UNIQUE INDEX "Leaderboard_contestId_key" ON "public"."Leaderboard"("contestId");

-- CreateIndex
CREATE UNIQUE INDEX "Leaderboard_rank_userId_key" ON "public"."Leaderboard"("rank", "userId");
